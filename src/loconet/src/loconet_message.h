...
/* Bit Masks */
#define LOCONET_MASK_ANY_OPCODE     0b10000000 // Any LocoNet OPCode Mask

#define LOCONET_MASK_ADDRESS_MSB    0b00001111 // Address Mask, most significant byte
#define LOCONET_MASK_ADDRESS_LSB    0b01111111 // Address Mask, least significant byte

#define LOCONET_MASK_SW_OUTPUT      0b00010000 // Switch Output Mask 
#define LOCONET_MASK_SW_DIRECTION   0b00100000 // Switch Direction Mask

#define LOCONET_MASK_INPUT_SOURCE   0b00010000 // Input Source Mask
#define LOCONET_MASK_INPUT_STATE    0b00100000 // Input State Mask 
...
typedef enum LocoNetInputSource {
    LOCONET_INPUT_SOURCE_AUX = 0,
    LOCONET_INPUT_SOURCE_SWITCH = 1
} LocoNetInputSource ;

typedef enum LocoNetInputState {
    LOCONET_INPUT_STATE_ON = 1,
    LOCONET_INPUT_STATE_OFF = 0
} LocoNetInputState ;

// Sensor Report (read sensor state)
typedef struct LocoNetMessageInputReport {
    uint16_t address;
    LocoNetInputSource source;
    LocoNetInputState state;
} LocoNetMessageInputReport ;
